...
* 
*    Rev 1.51   Nov 16 2006 14:59:56   tmielke
...
* 
*    Rev 1.50   Nov 13 2006 13:26:34   tmielke
* v1.79 build 2100 -- final network licensable version
* 
*    Rev 1.49   Jun 12 2006 15:13:32   tmielke
* v1.78:
...
* 
*    Rev 1.48   Nov 25 2005 01:32:34   tmielke
* v1.76: several bugfixes
* 
*    Rev 1.47   Nov 23 2005 16:11:34   tmielke
...
* 
*    Rev 1.46   Nov 11 2005 09:51:06   tmielke
* v1.74 release
...
* 
*    Rev 1.45   Jul 11 2005 08:52:52   tmielke
* v1.74 build 1632 (alphatest version)
* - SQLite index file
* - CListCtrls on playback tab
* - Workstations table support
* 
*    Rev 1.44   Jul 05 2005 01:50:30   tmielke
* improved performance & stability when copying or deleting recordings
* 
*    Rev 1.43   Jun 28 2005 01:46:36   tmielke
* v1.72 build 1250
* 
*    Rev 1.42   Jun 02 2005 01:30:38   tmielke
* v1.72 build 1207
* 
*    Rev 1.41   May 18 2005 13:47:20   tmielke
* v1.72 build 1200
* 
*    Rev 1.40   Mar 18 2005 16:12:10   tmielke
*  
* 
*    Rev 1.39   Mar 12 2005 07:08:44   tmielke
* v1.69
* 
*    Rev 1.38   Feb 22 2005 16:53:28   tmielke
* v1.67 build 960
* Added support for 957 Data Integration Linc to allow access in automatic recording mode.
* 
*    Rev 1.37   Nov 21 2004 01:29:22   tmielke
* v1.66 build 883
* 
*    Rev 1.36   Dec 04 2003 03:36:52   tmielke
* v1.66 buid 730 -- Database Index File Pre-Release
* 
*    Rev 1.35   Nov 18 2003 09:39:48   tmielke
* komisch, Workfile älter als Archive...
* Checkin anyway...
* 
*    Rev 1.34   Oct 03 2003 01:22:16   tmielke
* v1.65 build 572:
...
* 
* 
*    Rev 1.33   Sep 23 2003 01:48:12   tmielke
* v1.64 build 557 (improved control tone detection)
* 
*    Rev 1.32   Sep 12 2003 01:12:16   tmielke
*  
* 
*    Rev 1.31   Sep 11 2003 04:04:08   tmielke
*  
* 
*    Rev 1.30   Sep 04 2003 00:55:32   tmielke
* v1.64 build 514
* C: drive licensing problem solved
* added build count to better determine versions
* fixed problem with disk key licensing
* 
*    Rev 1.29   Aug 04 2003 00:35:08   tmielke
* v1.64
* 
*    Rev 1.28   Jun 09 2003 15:25:22   tmielke
* v1.63 final
* 
*    Rev 1.27   Jun 05 2002 19:31:58   tmielke
* v1.62
* 
*    Rev 1.26   May 05 2002 11:57:00   tmielke
* added machine name to subject line when requesting code via MAPI
* auto-inserted separators in search screen
* 
*    Rev 1.25   Mar 15 2002 20:22:42   tmielke
* v1.60
* 
*    Rev 1.24   Jan 28 2002 16:20:26   tmielke
* License Confirmation
* 
*    Rev 1.23   Nov 07 2001 02:40:40   tmielke
* v1.59 bugfix release
* 
*    Rev 1.22   Nov 06 2001 05:28:02   tmielke
* v1.58a
* 
*    Rev 1.21   Oct 12 2001 16:23:56   tmielke
* v1.58 bugfix wav export
* 
*    Rev 1.20   Sep 14 2001 04:13:10   
* v1.57
* 
*    Rev 1.19   06 Jun 2001 02:01:46   tmielke
* offizielle release 1.55
* 
*    Rev 1.18   17 May 2001 02:02:12   tmielke
* v1.54
* 
*    Rev 1.17   12 Feb 2001 19:37:46   tmielke
* v1.53
* 
*    Rev 1.16   20 Dec 2000 18:20:02   tmielke
* letzter check-in der VC++ 4.2 Version vor Wechsel auf Defeloper Studio 6.0
* 
*    Rev 1.15   04 Dec 2000 02:24:18   tmielke
* v1.52
* TPT-Anpassungen: Fernsteuerung, Folder scannen, Passwortsperre
* 
*    Rev 1.14   19 Oct 2000 02:30:04   tmielke
* v1.51:
* - ALC
...
* 
* 
*    Rev 1.13   19 Jun 2000 15:54:56   tmielke
* v1.44 letzte TRS-Version
* 
*    Rev 1.12   24 Mar 2000 22:36:50   tmielke
* v1.44 encrypting im hintergrund
* 
*    Rev 1.11   18 Mar 2000 11:40:50   tmielke
* zur sicherheit eingecheckt
* 
*    Rev 1.10   17 Mar 2000 05:32:22   tmielke
* v1.6 jetzt tauglich für Österreich/Schweitz
* 
*    Rev 1.9   05 Mar 2000 05:21:28   tmielke
* v1.43
* 
*    Rev 1.8   28 Feb 2000 00:31:02   tmielke
* v1.42
* 
*    Rev 1.7   24 Feb 2000 15:28:20   tmielke
* v1.41
* 
*    Rev 1.6   24 Feb 2000 01:23:32   tmielke
* v1.39
* 
*    Rev 1.5   18 Feb 2000 00:39:16   tmielke
* v1.38
* 
*    Rev 1.4   15 Dec 1999 03:34:12   tmielke
* v1.37 CAboutDlg auf OnEraseBkgnd umgestellt und Archivpfad prüfen
* 
*    Rev 1.3   01 Dec 1999 18:45:42   tmielke
...
* 
*    Rev 1.0   07 Jun 1999 19:00:14   tmielke
* Multi Language
* 
*/
