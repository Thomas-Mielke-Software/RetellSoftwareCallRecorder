...
*	Beschreibung:
*	
*	PasswortCheckDlg.cpp : implementation file
*	
*	$Log:   D:/pvcsarch/telar/passwortcheckdlg.cpv  $
* 
...
* v1.41
* 
*    Rev 1.5   24 Feb 2000 01:22:42   tmielke
* v1.39
* 
...
CPasswortCheckDlg::CPasswortCheckDlg(int Template, CString *ppw, CWnd* pParent /*=NULL*/)
	: CDialog(Template, pParent)
{
	//{{AFX_DATA_INIT(CPasswortCheckDlg)
...
void CPasswortCheckDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CPasswortCheckDlg)
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(CPasswortCheckDlg, CDialog)
	//{{AFX_MSG_MAP(CPasswortCheckDlg)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CPasswortCheckDlg message handlers

void CPasswortCheckDlg::OnOK() 
{
	char buffer[1000];
	GetDlgItemText(IDC_PASSWORT, buffer, sizeof(buffer));
	*m_ppw = (CString)buffer;
