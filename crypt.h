...
*	Beschreibung:
*	
*	Encryption/Decryption Hilfsfunktionen und Zufallsgenerator - Header file
*	
*	$Log:   D:/pvcsarch/telar/crypt.h_v  $
* 
*    Rev 1.55   Dec 19 2007 17:27:30   tmielke
* Adaptions to Windows Vista
* 
*    Rev 1.54   Oct 11 2007 10:15:02   tmielke
* Made the soundcard recognition more flexible in case plug and play
* soundcards have switched places.
* 
*    Rev 1.53   Sep 21 2007 15:47:18   tmielke
* Added Dutch translations and some additional debug code.
* 
*    Rev 1.52   Aug 14 2007 14:09:08   tmielke
* v1.83 resolved issues with voice modems and other exotic audio devices.
* 
*    Rev 1.51   May 09 2007 10:23:44   tmielke
...
* 
*    Rev 1.50   Nov 16 2006 14:59:46   tmielke
...
* 
*    Rev 1.49   Nov 13 2006 13:26:22   tmielke
* v1.79 build 2100 -- final network licensable version
* 
*    Rev 1.48   Jun 12 2006 15:13:22   tmielke
* v1.78:
...
* 
*    Rev 1.47   Nov 25 2005 01:32:18   tmielke
* v1.76: several bugfixes
* 
*    Rev 1.46   Nov 23 2005 16:11:20   tmielke
...
* 
*    Rev 1.45   Nov 11 2005 09:50:58   tmielke
* v1.74 release
...
* 
*    Rev 1.44   Jul 11 2005 08:52:34   tmielke
* v1.74 build 1632 (alphatest version)
* - SQLite index file
* - CListCtrls on playback tab
* - Workstations table support
* 
*    Rev 1.43   Jul 05 2005 01:50:18   tmielke
* improved performance & stability when copying or deleting recordings
* 
*    Rev 1.42   Jun 28 2005 01:46:26   tmielke
* v1.72 build 1250
* 
*    Rev 1.41   Jun 02 2005 01:30:26   tmielke
* v1.72 build 1207
* 
*    Rev 1.40   May 18 2005 13:47:10   tmielke
* v1.72 build 1200
* 
*    Rev 1.39   Mar 18 2005 16:12:00   tmielke
*  
* 
*    Rev 1.38   Mar 12 2005 07:08:32   tmielke
* v1.69
* 
*    Rev 1.37   Feb 22 2005 16:53:22   tmielke
* v1.67 build 960
* Added support for 957 Data Integration Linc to allow access in automatic recording mode.
* 
*    Rev 1.36   Nov 21 2004 01:29:16   tmielke
* v1.66 build 883
* 
*    Rev 1.35   Dec 04 2003 03:36:42   tmielke
* v1.66 buid 730 -- Database Index File Pre-Release
* 
*    Rev 1.34   Nov 18 2003 09:39:42   tmielke
* komisch, Workfile älter als Archive...
* Checkin anyway...
* 
*    Rev 1.33   Oct 03 2003 01:22:08   tmielke
* v1.65 build 572:
...
* 
* 
*    Rev 1.32   Sep 23 2003 01:48:04   tmielke
* v1.64 build 557 (improved control tone detection)
* 
*    Rev 1.31   Sep 12 2003 01:12:10   tmielke
*  
* 
*    Rev 1.30   Sep 11 2003 04:04:04   tmielke
*  
* 
*    Rev 1.29   Sep 04 2003 00:55:26   tmielke
* v1.64 build 514
* C: drive licensing problem solved
* added build count to better determine versions
* fixed problem with disk key licensing
* 
*    Rev 1.28   Aug 04 2003 00:34:58   tmielke
* v1.64
* 
*    Rev 1.27   Jun 09 2003 15:25:16   tmielke
* v1.63 final
* 
*    Rev 1.26   Jun 05 2002 19:31:54   tmielke
* v1.62
* 
*    Rev 1.25   May 05 2002 11:56:16   tmielke
* added machine name to subject line when requesting code via MAPI
* auto-inserted separators in search screen
* 
*    Rev 1.24   Mar 15 2002 20:21:52   tmielke
* v1.60
* 
...
* 
*    Rev 1.20   Sep 14 2001 04:12:30   
* v1.57
* 
*    Rev 1.19   06 Jun 2001 02:00:08   tmielke
* offizielle release 1.55
* 
*    Rev 1.18   17 May 2001 02:01:06   tmielke
* v1.54
* 
*    Rev 1.17   12 Feb 2001 19:36:46   tmielke
* v1.53
* 
*    Rev 1.16   20 Dec 2000 18:18:18   tmielke
* letzter check-in der VC++ 4.2 Version vor Wechsel auf Defeloper Studio 6.0
* 
*    Rev 1.15   04 Dec 2000 02:22:52   tmielke
* v1.52
...
* v1.39
* 
*    Rev 1.5   18 Feb 2000 00:38:46   tmielke
* v1.38
* 
...
* 
*    Rev 1.2   01 Dec 1999 16:57:34   tmielke
* v1.34
* 
*    Rev 1.1   25 Aug 1999 12:29:58   tmielke
...
extern void EC(int m, int n, char *source, char *dest);
extern void ECL(int m, int n, char *source, char *dest, int length);
extern BOOL DC(int m, int n, char *source, char *dest);
