...
*	Beschreibung:
*	
*	PasswortDlg.h : implementation file für das Doppel-Checken von Passwörtern
*	
*	$Log:   D:/pvcsarch/telar/passwortdlg.cpv  $
* 
...
* v1.64
* 
*    Rev 1.28   Jun 09 2003 15:25:18   tmielke
* v1.63 final
* 
...
* 
*    Rev 1.23   Nov 06 2001 05:27:04   tmielke
* v1.58a
* 
...
* v1.54
* 
*    Rev 1.18   12 Feb 2001 19:36:58   tmielke
* v1.53
* 
*    Rev 1.17   20 Dec 2000 18:18:38   tmielke
...
* 
*    Rev 1.15   19 Oct 2000 02:28:52   tmielke
* v1.51:
* - ALC
...
* 
* 
*    Rev 1.14   19 Jun 2000 15:54:12   tmielke
* v1.44 letzte TRS-Version
* 
*    Rev 1.13   24 Mar 2000 22:36:18   tmielke
* v1.44 encrypting im hintergrund
* 
*    Rev 1.12   18 Mar 2000 11:40:18   tmielke
* zur sicherheit eingecheckt
* 
*    Rev 1.11   17 Mar 2000 05:31:52   tmielke
* v1.6 jetzt tauglich für Österreich/Schweitz
* 
*    Rev 1.10   05 Mar 2000 05:20:54   tmielke
* v1.43
* 
*    Rev 1.9   28 Feb 2000 00:30:36   tmielke
* v1.42
* 
*    Rev 1.8   24 Feb 2000 15:27:54   tmielke
* v1.41
* 
*    Rev 1.7   24 Feb 2000 01:22:44   tmielke
* v1.39
* 
...
CPasswortDlg::CPasswortDlg(int nTemplate, CString &pw, CWnd* pParent /*=NULL*/)
	: CDialog(nTemplate, pParent)
{
	//{{AFX_DATA_INIT(CPasswortDlg)
...
void CPasswortDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CPasswortDlg)
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(CPasswortDlg, CDialog)
	//{{AFX_MSG_MAP(CPasswortDlg)
	ON_WM_TIMER()
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CPasswortDlg message handlers

void CPasswortDlg::OnOK() 
{
	char buffer[1000];

	GetDlgItemText(IDC_PASSWORT, buffer, sizeof(buffer));
	
	if ((CString)buffer == m_pw)
		CDialog::OnOK();
	else
		LANG_MESSAGEBOX2(IDS_STRING40, MB_ICONEXCLAMATION); 
}

BOOL CPasswortDlg::OnInitDialog() 
{
	CDialog::OnInitDialog();
	
	if (m_what_password != -1)
	{
		;	//
	}
...
BOOL CPasswortDlg::PreCreateWindow(CREATESTRUCT& cs) 
{
...
void CPasswortDlg::OnTimer(UINT_PTR nIDEvent) 
{
	...
	AfxGetMainWnd()->SetWindowPos(&wndTopMost, 0, 0, 0, 0, SWP_NOMOVE|SWP_NOSIZE|SWP_HIDEWINDOW);					
