...
* 
*    Rev 1.26   Nov 16 2006 14:59:36   tmielke
...
* 
*    Rev 1.25   Nov 13 2006 13:26:12   tmielke
* v1.79 build 2100 -- final network licensable version
* 
*    Rev 1.24   Jun 12 2006 15:13:14   tmielke
* v1.78:
...
* 
*    Rev 1.23   Nov 25 2005 01:32:02   tmielke
* v1.76: several bugfixes
* 
*    Rev 1.22   Nov 23 2005 16:11:08   tmielke
...
* 
*    Rev 1.21   Nov 11 2005 09:50:46   tmielke
* v1.74 release
...
* 
*    Rev 1.20   Jul 11 2005 08:52:18   tmielke
* v1.74 build 1632 (alphatest version)
* - SQLite index file
* - CListCtrls on playback tab
* - Workstations table support
* 
*    Rev 1.19   Jul 05 2005 01:50:12   tmielke
* improved performance & stability when copying or deleting recordings
* 
*    Rev 1.18   Jun 28 2005 01:46:20   tmielke
* v1.72 build 1250
* 
*    Rev 1.17   Jun 02 2005 01:30:20   tmielke
* v1.72 build 1207
* 
*    Rev 1.16   May 18 2005 13:47:06   tmielke
* v1.72 build 1200
* 
*    Rev 1.15   Mar 18 2005 16:11:54   tmielke
*  
* 
*    Rev 1.14   Mar 12 2005 07:08:24   tmielke
* v1.69
* 
*    Rev 1.13   Feb 22 2005 16:53:18   tmielke
* v1.67 build 960
* Added support for 957 Data Integration Linc to allow access in automatic recording mode.
* 
*    Rev 1.12   Nov 21 2004 01:29:12   tmielke
* v1.66 build 883
* 
*    Rev 1.11   Dec 04 2003 03:36:36   tmielke
* v1.66 buid 730 -- Database Index File Pre-Release
* 
*    Rev 1.10   Nov 18 2003 09:39:38   tmielke
* komisch, Workfile älter als Archive...
* Checkin anyway...
* 
*    Rev 1.9   Oct 03 2003 01:22:06   tmielke
* v1.65 build 572:
...
* 
* 
*    Rev 1.8   Sep 23 2003 01:47:58   tmielke
* v1.64 build 557 (improved control tone detection)
* 
*    Rev 1.7   Sep 12 2003 01:12:08   tmielke
*  
* 
*    Rev 1.6   Sep 11 2003 04:04:02   tmielke
*  
* 
*    Rev 1.5   Sep 04 2003 00:55:24   tmielke
* v1.64 build 514
* C: drive licensing problem solved
* added build count to better determine versions
* fixed problem with disk key licensing
* 
*    Rev 1.4   Aug 04 2003 00:34:56   tmielke
* v1.64
* 
*    Rev 1.3   Jun 09 2003 15:25:14   tmielke
* v1.63 final
* 
*    Rev 1.2   Jun 05 2002 19:31:54   tmielke
* v1.62
* 
*    Rev 1.1   May 05 2002 11:56:08   tmielke
* added machine name to subject line when requesting code via MAPI
* auto-inserted separators in search screen
* 
*    Rev 1.0   Apr 19 2002 07:25:30   tmielke
*  
*
