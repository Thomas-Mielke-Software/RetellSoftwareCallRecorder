...
* 
*    Rev 1.33   Nov 16 2006 14:59:58   tmielke
...
* 
*    Rev 1.32   Nov 13 2006 13:26:36   tmielke
* v1.79 build 2100 -- final network licensable version
* 
*    Rev 1.31   Jun 12 2006 15:13:32   tmielke
* v1.78:
...
* 
*    Rev 1.30   Nov 25 2005 01:32:34   tmielke
* v1.76: several bugfixes
* 
*    Rev 1.29   Nov 23 2005 16:11:34   tmielke
...
* 
*    Rev 1.28   Nov 11 2005 09:51:08   tmielke
* v1.74 release
...
* 
*    Rev 1.27   Jul 11 2005 08:52:52   tmielke
* v1.74 build 1632 (alphatest version)
* - SQLite index file
* - CListCtrls on playback tab
* - Workstations table support
* 
*    Rev 1.26   Jul 05 2005 01:50:32   tmielke
* improved performance & stability when copying or deleting recordings
* 
*    Rev 1.25   Jun 28 2005 01:46:36   tmielke
* v1.72 build 1250
* 
*    Rev 1.24   Jun 02 2005 01:30:38   tmielke
* v1.72 build 1207
* 
*    Rev 1.23   May 18 2005 13:47:20   tmielke
* v1.72 build 1200
* 
*    Rev 1.22   Mar 18 2005 16:12:10   tmielke
*  
* 
*    Rev 1.21   Mar 12 2005 07:08:46   tmielke
* v1.69
* 
*    Rev 1.20   Feb 22 2005 16:53:30   tmielke
* v1.67 build 960
* Added support for 957 Data Integration Linc to allow access in automatic recording mode.
* 
*    Rev 1.19   Nov 21 2004 01:29:24   tmielke
* v1.66 build 883
* 
*    Rev 1.18   Dec 04 2003 03:36:52   tmielke
* v1.66 buid 730 -- Database Index File Pre-Release
* 
*    Rev 1.17   Nov 18 2003 09:39:48   tmielke
* komisch, Workfile älter als Archive...
* Checkin anyway...
* 
*    Rev 1.16   Oct 03 2003 01:22:16   tmielke
* v1.65 build 572:
...
* 
* 
*    Rev 1.15   Sep 23 2003 01:48:12   tmielke
* v1.64 build 557 (improved control tone detection)
* 
*    Rev 1.14   Sep 12 2003 01:12:16   tmielke
*  
* 
*    Rev 1.13   Sep 11 2003 04:04:10   tmielke
*  
* 
*    Rev 1.12   Sep 04 2003 00:55:34   tmielke
* v1.64 build 514
* C: drive licensing problem solved
* added build count to better determine versions
* fixed problem with disk key licensing
* 
*    Rev 1.11   Aug 04 2003 00:35:08   tmielke
* v1.64
* 
*    Rev 1.10   Jun 09 2003 15:25:24   tmielke
* v1.63 final
* 
*    Rev 1.9   Jun 05 2002 19:31:58   tmielke
* v1.62
* 
*    Rev 1.8   May 05 2002 11:57:04   tmielke
* added machine name to subject line when requesting code via MAPI
* auto-inserted separators in search screen
* 
*    Rev 1.7   Mar 15 2002 20:22:54   tmielke
* v1.60
* 
*    Rev 1.6   Nov 07 2001 02:40:46   tmielke
* v1.59 bugfix release
* 
*    Rev 1.5   Nov 06 2001 05:28:08   tmielke
* v1.58a
* 
*    Rev 1.4   Oct 12 2001 16:24:06   tmielke
* v1.58 bugfix wav export
* 
*    Rev 1.3   Sep 14 2001 04:13:14   
* v1.57
* 
*    Rev 1.2   06 Jun 2001 02:01:56   tmielke
* offizielle release 1.55
* 
*    Rev 1.1   17 May 2001 02:02:18   tmielke
* v1.54
* 
*    Rev 1.0   17 May 2001 00:33:36   tmielke
* Initial CheckIn
*
*
*/
