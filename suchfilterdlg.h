...
*	Beschreibung:
*	
*	SuchfilterDlg.h : header file
*	
*	$Log:   D:/pvcsarch/telar/suchfilterdlg.h_v  $
* 
...
* 
*    Rev 1.52   May 09 2007 10:23:56   tmielke
...
* 
*    Rev 1.49   Jun 12 2006 15:13:30   tmielke
* v1.78:
...
* 
*    Rev 1.48   Nov 25 2005 01:32:32   tmielke
...
* 
*    Rev 1.45   Jul 11 2005 08:52:50   tmielke
...
* v1.72 build 1207
* 
*    Rev 1.41   May 18 2005 13:47:18   tmielke
* v1.72 build 1200
* 
*    Rev 1.40   Mar 18 2005 16:12:08   tmielke
*  
* 
...
* 
* 
*    Rev 1.33   Sep 23 2003 01:48:10   tmielke
...
* 
*    Rev 1.29   Aug 04 2003 00:35:06   tmielke
* v1.64
* 
...
* v1.60
* 
*    Rev 1.22   Nov 07 2001 02:40:36   tmielke
...
* 
*    Rev 1.9   17 Mar 2000 05:32:18   tmielke
* v1.6 jetzt tauglich für Österreich/Schweitz
* 
*    Rev 1.8   05 Mar 2000 05:21:24   tmielke
* v1.43
* 
*    Rev 1.7   28 Feb 2000 00:30:56   tmielke
* v1.42
* 
*    Rev 1.6   24 Feb 2000 15:28:16   tmielke
* v1.41
* 
...
* v1.38
* 
*    Rev 1.3   15 Dec 1999 03:34:06   tmielke
* v1.37 CAboutDlg auf OnEraseBkgnd umgestellt und Archivpfad prüfen
* 
*    Rev 1.2   01 Dec 1999 18:45:38   tmielke
* v1.36 BPS -> Frohberg GmbH
* 
*    Rev 1.1   16 Aug 1999 10:31:46   tmielke
* v1.34
* 
...
#if !defined(__SUCHFILTERDLG_H__)
#define __SUCHFILTERDLG_H__

class CSuchfilterDlg : public CDialog
{
// Construction
public:
	CSuchfilterDlg(int Template, CTelArPropertyPage2* pParent);   // standard constructor

// Dialog Data
	//{{AFX_DATA(CSuchfilterDlg)
	enum { IDD = IDD_SUCHFILTER };
	CString	m_Gespraechspartner;
	CString	m_Identifikation;
	CString	m_Notizen;
	CString	m_DatumVon;
	CString	m_DatumBis;
	CString	m_MaxDauer;
...
protected:
	...
	CTelArPropertyPage2* m_pParent;

	void AddSeparator(int nIDStatic, int nID);

	// Generated message map functions
	//{{AFX_MSG(CSuchfilterDlg)
	virtual BOOL OnInitDialog();
	afx_msg void OnDestroy();
	virtual void OnOK();
	afx_msg void OnChangeIdentifikation();
	afx_msg void OnChangeGespraechspartner();
	afx_msg void OnChangeNotizen();
	afx_msg void OnChangeDatumNach();
	afx_msg void OnChangeDatumVor();
	afx_msg void OnChangeZeitNach();
	afx_msg void OnChangeZeitVor();
	afx_msg void OnChangeMaxDauer();
	afx_msg void OnChangeMinDauer();
